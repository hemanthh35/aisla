            ...
            <>
                ...
                <div className="provider-cards">
                  ...
                  <div
                    className={`provider-card ${
                      settings.provider === "ollama" ? "active" : ""
                    } ${!status.ollama?.available ? "unavailable" : ""}`}
                    onClick={() =>
                  ...
                  >
                    ...
                    <p className="provider-desc">
                      Run AI models locally on your machine. No internet
                  ...
                  <div
                    className={`provider-card ${
                      settings.provider === "gemini" ? "active" : ""
                    } ${!status.gemini?.available ? "unavailable" : ""}`}
                    onClick={() =>
                  ...
                  >
                    ...
                    <div className="provider-status">
                      <span
                        className={`status-dot ${
                          status.gemini?.available ? "online" : "offline"
                        }`}
                      ></span>
                      {status.gemini?.available
                        ? "API Key Configured"
                    ...
                    <p className="provider-desc">
                      Use Google's Gemini 2.0 Flash model. Fast, powerful, and
                      always available.
                    </p>
                    {!status.gemini?.available && (
                ...
                <div className="settings-grid">
                  ...
                  {settings.provider === "gemini" && (
                    <div className="setting-group">
                      ...
                      <span className="setting-hint">
                        Gemini 2.0 Flash offers best performance
                      </span>
                    </div>
                  )}
              ...
              <section className="settings-section">
                ...
                <div className="test-buttons">
                  <button
                    className={`test-btn ollama ${
                      testing === "ollama" ? "testing" : ""
                    }`}
